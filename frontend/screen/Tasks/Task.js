        ...
        <Card.Content>
          ...
          <View>
            <View
              ...
              <Paragraph style={{fontSize: SIZES.h2, paddingTop: 5}}>
                {task.title}
              </Paragraph>
              <Paragraph style={{marginRight: 5}}>
                {task.category !== 1 && task.category > 3
                  ? 'Habit'
                  : task.category === 3
                  ? 'Appointment'
                  : task.category === 2
            ...
            <View style={{flexDirection: 'row', alignItems: 'center'}}>
              ...
              <Paragraph style={{fontSize: SIZES.body4}}>
                {' '}
                {moment(task.startDate).format('YYYY-MM-DD h:mm a')} ~{' '}
                {moment(task.endDate).format('YYYY-MM-DD h:mm a')}
              </Paragraph>
            </View>
          </View>
          {/* 概要 */}
          <View style={{maxHeight: 550}}>
            <Paragraph style={{fontSize: SIZES.h4, marginVertical: 10}}>
              概要
            </Paragraph>
            <ScrollView style={styles.description}>
              <Paragraph style={{fontSize: SIZES.h4, minHeight: 500}}>
                {task.description}
              </Paragraph>
            </ScrollView>
          </View>
          ...
          <View style={{marginTop: 5}}>
            ...
            <View
              ...
              <Paragraph style={{fontSize: SIZES.h4}}>
                {' '}
                {task.emergency !== 1 && task.emergency > 2
                  ? 'High'
                  : task.emergency === 2
                  ? 'Medium'
                  : 'Low'}
